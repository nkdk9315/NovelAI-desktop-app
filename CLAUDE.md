...
│   ├── contracts/             # README.md（索引）, models.md, repositories.md, services.md,
│   │                          # commands.md, frontend.md, design-decisions.md, test-strategy.md
...
├── commands/       # 11モジュール (settings, project, image, generation, prompt_group, genre, vibe, style_preset, prompt_presets, preset_folders, sidebar_preset_groups)
├── services/       # 10モジュール (同上 + system_prompt, prompt_preset, preset_folder, sidebar_preset_group)
├── repositories/   # 10モジュール (settings, project, image, prompt_group, genre, vibe, style_preset, prompt_preset, preset_folder, sidebar_preset_group)
...
- `docs/contracts/` — DTO 定義・Repository/Service/Command 署名
  - `models.md` — Row structs / IPC DTO / Request DTO
  - `repositories.md` — Repository 関数シグネチャ
  - `services.md` — Service 関数シグネチャ
  - `commands.md` — Tauri コマンド定義
  - `frontend.md` — TypeScript 型定義・IPC ラッパー・フロントエンドユーティリティ
  - `design-decisions.md` — 設計上の重要な決定
