...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prompt_group_folders::list_prompt_group_folders,
            commands::prompt_group_folders::create_prompt_group_folder,
            commands::prompt_group_folders::rename_prompt_group_folder,
            commands::prompt_group_folders::move_prompt_group_folder,
            commands::prompt_group_folders::delete_prompt_group_folder,
            commands::prompt_group_folders::delete_prompt_groups_in_folder,
            commands::prompt_group_folders::count_prompt_groups_in_folder,
            commands::prompt_group_folders::set_prompt_group_folder,
            ...
            commands::vibe_folders::list_vibe_folder_roots,
            commands::vibe_folders::list_vibe_folder_children,
            commands::vibe_folders::create_vibe_folder,
            commands::vibe_folders::rename_vibe_folder,
            commands::vibe_folders::move_vibe_folder,
            commands::vibe_folders::delete_vibe_folder,
            commands::vibe_folders::set_vibe_folder,
            commands::vibe_folders::count_vibes_per_folder,
            commands::style_preset_folders::list_style_preset_folder_roots,
            commands::style_preset_folders::list_style_preset_folder_children,
            commands::style_preset_folders::create_style_preset_folder,
            commands::style_preset_folders::rename_style_preset_folder,
            commands::style_preset_folders::move_style_preset_folder,
            commands::style_preset_folders::delete_style_preset_folder,
            commands::style_preset_folders::set_style_preset_folder,
            commands::style_preset_folders::count_style_presets_per_folder,
            ...
            commands::prompt_presets::list_prompt_presets,
            commands::prompt_presets::get_prompt_preset,
            ...
            commands::preset_folders::move_preset_folder,
            commands::preset_folders::delete_preset_folder,
            commands::preset_folders::delete_presets_in_folder,
            commands::preset_folders::count_presets_in_folder,
            commands::preset_folders::set_preset_folder,
            commands::sidebar_preset_groups::list_sidebar_preset_group_instances,
            commands::sidebar_preset_groups::create_sidebar_preset_group_instance,
            commands::sidebar_preset_groups::update_sidebar_preset_group_pair,
            commands::sidebar_preset_groups::set_sidebar_preset_group_active_presets,
            commands::sidebar_preset_groups::delete_sidebar_preset_group_instance,
